...
sankey-finance.js -i input_file -o output_file -a [left|right|center|justify] -A -n -l -w [image_width] -h [image_height] -p [node_padding] -d [node_width]
...
Options:
  ...
  -A, --auto         Auto-fit node width and padding to image size (ignores -d and -p)  [boolean]

Examples:
  sankey-finance.js -i Nokia_results.xlsx -o Nokia_results.svg -a right -n -l A -w 1024 -h 768
```
